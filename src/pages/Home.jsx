...
export const Home = () => {
    ...
    return (
        <div className="font-sans">
            {/* NAVBAR MEJORADO */}
            <nav className="fixed w-full z-[60] bg-slate-900 backdrop-blur-md border-b border-slate-800 shadow-md transition-all duration-300">
                        ...
                        {!token ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-white hover:bg-slate-100 text-slate-900 text-sm font-semibold rounded-full transition-all shadow-lg hover:shadow-white/20 transform hover:-translate-y-0.5"
                                >
                                    Iniciar Sesión
                                </button>
                            </>
